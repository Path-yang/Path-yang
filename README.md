...
<br> 
In a team of 5, we built SentinelAI, an AI-powered safety system using CCTV/IP cameras to detect falls, strokes, and industrial accidents in real time, leveraging existing camera infrastructure with machine learning to prevent tragedies before they happen.
<br>
Even though SentinelAI didn't move forward and get funded, it taught us valuable lessons about evaluating technical feasibility vs. impact, and the importance of building projects with real-world depth and sustainability. Notably, a closely analogous company, [Lexius](https://www.ycombinator.com/companies/lexius), was later accepted into Y Combinator W26, proving that the core concept had real potential, and reminding us never to give up on an idea too early.
...
Built during *NUS Hack&Roll 2026* in a team of 4. 
<br> 
...
Built during *NUS Fintech Summit 2026* in a team of 5. 
<br>
SigmaPay is a cross-border financial platform built on the XRP Ledger that enables instant remittances, conditional escrow payments, and real-world asset tokenization.
...
<br>
It is a comprehensive senior focused web application, featuring AI companionship with streaming avatars, hobby exploration hub, social feed, and community class integration. 

### 🏥 [SigmaHealth](https://github.com/clemenong1/Sigmapore)
**🏆 Finalist (Top 10 out of 60+ teams), best usage of data, best team for Theme 1: Health and Wellbeing** @ *NUS Lifehack 2025*
<br>
...
**🏆 Top 3 (Called for top 3 in University Category out of 93 teams, final ranking undetermined due to absence from oral presentation)** @ *NUS & SMF Maritime Hackathon 2025*
<br>
